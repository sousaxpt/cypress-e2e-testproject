      ...
      <section className="banner">
        <div className="container">
          ...
          <div className="row">
            ...
            <button type="button" onClick={() => setDay('Wednesday')} className="btn-oval" data-cy="Wednesday">
              Wednesday
            </button>
            <button type="button" onClick={() => setDay('Thursday')} className="btn-oval" data-cy="Thursday">
              Thursday
            </button>
